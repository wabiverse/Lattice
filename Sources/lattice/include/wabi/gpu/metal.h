...
#ifndef LATTICEMETAL_SWIFT_H
#define LATTICEMETAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LatticeMetal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
#undef SWIFT_SYMBOL
#endif
#define SWIFT_SYMBOL(usrValue) SWIFT_SYMBOL_MODULE_USR("LatticeMetal", usrValue)
...
namespace LatticeMetal SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("LatticeMetal") {
...
class LatticeGPUComponent { } SWIFT_UNAVAILABLE_MSG("protocol 'LatticeGPUComponent' can not yet be represented in C++");

template<class T_0_0>
#ifdef __cpp_concepts
requires swift::isUsableInGenericContext<T_0_0>
#endif // __cpp_concepts
class MetalBackedColumn { } SWIFT_UNAVAILABLE_MSG("generic generic class 'MetalBackedColumn' can not yet be exposed to C++");

} // namespace LatticeMetal
